...
class CiberPuntFrausScreen extends StatefulWidget {
  final bool isCheeseSquare;
  const CiberPuntFrausScreen({super.key, this.isCheeseSquare = false});

  @override
  State<CiberPuntFrausScreen> createState() => _CiberPuntFrausScreenState();
}

class _CiberPuntFrausScreenState extends State<CiberPuntFrausScreen> {
  ...
  Future<void> _initialize() async {
    ...
    setState(() {
      ...
      _currentQuestion = quizService.getRandomQuestion('FrausEnLinia');
    });
  }
 ...
 @override
  Widget build(BuildContext context) {
    if (_currentQuestion == null) {
      return Scaffold(
        appBar: AppBar(title: const Text('Punt: Fraus en Línia')),
        body: Center(
          child: Column(
    ...
    return Scaffold(
      ...
      body: SingleChildScrollView(
        ...
        child: Column(
          ...
          children: [
            Image.asset('assets/images/osi-trivial-ciberpunt-fraus-en-linia.jpg'),
            const SizedBox(height: 20),
            Text(
