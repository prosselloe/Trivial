...
class CiberPuntXarxesScreen extends StatefulWidget {
  final bool isCheeseSquare;
  const CiberPuntXarxesScreen({super.key, this.isCheeseSquare = false});

  @override
  State<CiberPuntXarxesScreen> createState() => _CiberPuntXarxesScreenState();
}

class _CiberPuntXarxesScreenState extends State<CiberPuntXarxesScreen> {
  ...
  Future<void> _initialize() async {
    ...
    setState(() {
      ...
      _currentQuestion = quizService.getRandomQuestion('XarxesSocials');
    });
  }
 ...
 @override
  Widget build(BuildContext context) {
    if (_currentQuestion == null) {
      return Scaffold(
        appBar: AppBar(title: const Text('Punt: Xarxes Socials')),
        body: Center(
          child: Column(
    ...
    return Scaffold(
      ...
      body: SingleChildScrollView(
        ...
        child: Column(
          ...
          children: [
            Image.asset('assets/images/osi-trivial-ciberpunt-xarxes-socials-i-missatgeria-instantania.jpg'),
            const SizedBox(height: 20),
            Text(
